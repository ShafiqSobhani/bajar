...
<div style="background-color: hsl(60, 56%, 91%); border-radius: 5px;" class="container-fluid text-center">
    <a href="default.php"><img src="image/LogoVbajar6.png" width="100px" alt="VBajar Image"></a>    <h3 style="color: rgb(82, 9, 9);">Bringing the Best to Your Doorstep: VBajar - Your Premier Online Marketplace</h3>
</div>
...
<nav class="navbar navbar-inverse" id="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="default.php">VBajar</a>
                ...
                <ul class="nav navbar-nav" style="text-decoration: none;">
                    <li style="text-decoration: none;">
                        <h4 style="color: rgb(100, 255, 355); text-decoration: none; margin-top: 8px;">
                            ...
                            <a href="default.php" style="color: inherit; text-decoration: none;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="image/LogoVbajar6.png" width="50px" alt="logo"> VBajar - Your Premier Online Marketplace</a>
